         ...
         <div className="col-lg-12">
            <div className="tp-about-wrapper">
               <div className="tp-about-title-wrapper">
                  <span className="tp-section-title-pre">Project Overview</span>

               </div>
               <p>Company.in Is All About Modern Digital
                  Technologies.
                  Company.in is all about modern digital
                  technologies, web3 and latest applications and
                  cultivating value exchange trends on a global scale.</p>
               <p>Our success is achieved through accurate
                  calculation, prediction and the ability to
                  choose the right strategy. Our analysts are
                  monitoring the situations that can affect
                  the decrease or increase in exchange rates
                  closely.</p>
               <p>Being the largest financial market with a daily turnover of around $7.5
                  trillion, the forex market is attracting traders from all across the globe.
                  With many more favourable conditions for traders, Forex Trading in World
                  is getting more prominence than ever before. When done with the right
                  strategies, any determined trader could earn unmatchable profits at the
                  end of the day. A successful forex trader would purchase one currency
                  and sell them at the right time with the help of mediators called forex
                  brokers. If you are new to the forex market and trading, it is important to
                  be guided by the right people.</p>
                  <p>
                  Founded in [2018] by a team of experienced traders, developers, and AI experts, Company.in was born out of a passion for innovation and a commitment to excellence. Our journey began with a simple question: "How can we harness the power of AI to make Forex trading more accessible, efficient, and profitable?"
                  </p>
                  <p>
                     AI-Powered Aiden Insight Charts Company.in’s Path to Enhanced Growth and Governance Following Q3 Board Meeting
Abu Dhabi, UAE: Company.in (ADX:Company.in), the global diversified Abu Dhabi-based conglomerate, announced groundbreaking recommendations from Aiden Insight, its AI-powered Board Observer, during Company.in’s Q3 2024 board meeting. Aiden's insights are set to steer Company.in towards strategic refinement and operational excellence in Q4 and beyond.
</p>
<p>
Aiden Insight, appointed earlier this year to further strengthen Company.in’s corporate governance, has proven instrumental in analyzing vast datasets, identifying inefficiencies, and proposing forward-thinking strategies. During the Q3 board meeting, Aiden highlighted both opportunities and challenges across Company.in's diverse business segments, emphasizing critical actions required for sustainable growth.
                  </p>
               <div className="tp-about-btn">
                  <a className="tp-btn" href="/">Read More <span><i className="fa-regular fa-plus"></i></span></a>
               </div>
            </div>
         </div>
      </div>
...
{/* <!-- service area start --> */}
<section className="tp-service-area pt-120 pb-90" data-bg-color="#F6F6F9">
   <div className="container">
      <div className="row">
         <div className="col-lg-6 col-md-8">
            <div className="tp-service-title-wrapper mb-40">
               <span className="tp-section-title-pre"> Core Values</span>
               <h3 className="tp-section-title">Methodology</h3>
            </div>
         </div>
         ...
         <div className="tp-service-active swiper-container wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
            <div className="swiper-wrapper mb-30 mt-40">
               <div className="swiper-slide">
                  <div className="tp-service-item-wrapper p-relative">
                     ...
                     <div className="tp-service-item-content">
                        <h4 className="tp-service-item-title"><a href="/">Integrity
                           </a></h4>
                        <p>We prioritize honesty and ethical conduct in all
                           aspects of our business.</p>
                     </div>
                     <div className="tp-service-item-thumb">
                        <a href="/"><img src="assets/img/service/img-1.jpg" alt="" /></a>
                     </div>
                  </div>
               </div>
               <div className="swiper-slide">
                  <div className="tp-service-item-wrapper p-relative">
                     ...
                     <div className="tp-service-item-content">
                        <h4 className="tp-service-item-title"><a href="/">Shared Prosperity</a></h4>
                        <p>Our success is shared equitably with our
                           marketing partners, ensuring collective growth.</p>
                     </div>
                     <div className="tp-service-item-thumb">
                        <a href="/"><img src="assets/img/service/img-2.jpg" alt="" /></a>
                     </div>
                  </div>
               </div>
               <div className="swiper-slide">
                  <div className="tp-service-item-wrapper p-relative">
                     ...
                     <div className="tp-service-item-content">
                        <h4 className="tp-service-item-title"><a href="/">Quality Excellence</a></h4>
                        <p>Our unwavering commitment isto deliver the highest quality products and services.</p>
                     </div>
                     <div className="tp-service-item-thumb">
                        <a href="/"><img src="assets/img/service/img-3.jpg" alt="" /></a>
                     </div>
                  </div>
               </div>
            </div>
...
{/* <!-- process area start --> */}
<section className="tp-process-arae pt-1 pb-120" data-bg-color="#F6F6F9">
   <div className="container">
      <div className="row">
         <div className="col-lg-12">
            <div className="tp-process-wrapper mt-100">
               <div className="tp-process-title mb-40">
                  <span className="tp-section-title-pre"> Core Development</span>
                  <h3 className="tp-section-title">Our Features</h3>
               </div>
               <div className="tp-process-item d-flex align-items-center">
                  ...
                  <div className="tp-process-item-content">
                     <h4 className="tp-process-item-title">Model Development</h4>
                     <p>We design and implement machine learning and deep learning models tailored to
                        the specific requirements of the Forex industry. This involves experimenting with
                        different architectures, hyperparameters, and optimization techniques. We deliver
                        across all platforms like Meta Trader 5 for both mobile & web.</p>
                  </div>
               </div>
               <div className="tp-process-item d-flex align-items-center">
                  <div className="tp-process-item-icon">
                  ...
                  <div className="tp-process-item-content">
                     <h4 className="tp-process-item-title">Evaluation Metrics</h4>
                     <p>We define appropriate metrics to assess the
                           performance of our AI models, such as accuracy,
                           precision, recall, F1 score, and area under the curve
                           (AUC). These metrics help us quantify the
                           effectiveness of our solutions. AI models work in
                           sync with our human traders and we at Company.inOT
                           ensure the growth of Your Money.</p>
                  </div>
               </div>
               <div className="tp-process-item d-flex align-items-center">
                  <div className="tp-process-item-icon">
                  ...
                  <div className="tp-process-item-content">
                     <h4 className="tp-process-item-title">Result and Impact</h4>
                     <p>Our AI powered trades will fetch great results for as long as
                        the investors are willing to pool in funds. At Company.inOT our aim
                        is to establish a hassel free and profitable business. Our
                        level plans ensure growth and AI trades ensure stability in
                        the growth patterns.
                     </p>
                     <p>
                        Investments grow steadily and traders enjoy huge profit
                        margins. So far Company.inOT has generated approximately a
                        profit of 2.7 Million USD across 5 countries.
                     </p>
                  </div>
               </div>
            </div>
...
{/* <!-- blog area start --> */}
<section className="tp-blog-area pt-120 pb-90">
   <div className="container">
      <div className="row">
         <div className="col-lg-12">
            <div className="tp-blog-title-wrapper text-center mb-40 mb-105">
               <span className="tp-section-title-pre">Understanding Forex </span>
               <h3 className="tp-section-title">Forex Markets & Opportunity</h3>
            </div>
         </div>
      </div>
      <div className="row">
         <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="tp-blog-item-wrapper p-relative mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
               <div className="tp-blog-item-thumb">
                  <a href="/"><img src="assets/img/blog/2img.jpg" alt="" /></a>
               </div>

               <div className="tp-blog-item-content">

                  <h4 className="tp-blog-item-title"><a href="#!">Vision</a></h4>
                  <p>

                     It is our Vision to bring some order and
                     respectability to this industry by sharing
                     our experiences and knowledge to make a success
                     of Forex Trading.</p>
               </div>
            </div>
         </div>
         <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="tp-blog-item-wrapper p-relative mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
               <div className="tp-blog-item-thumb">
                  <a href="/"><img src="assets/img/blog/3img.jpg" alt="" /></a>
               </div>

               <div className="tp-blog-item-content">

                  <h4 className="tp-blog-item-title"><a href="#!">Values</a></h4>
                  <p>
                     Company.in is committed to core values - Integrity, Customer Focused Culture, Trust, Respect and Care for the Individual, Passion for Excellence, Teamwork.</p>
               </div>
            </div>
         </div>
         <div className="col-xl-4 col-lg-6 col-md-6">
            <div className="tp-blog-item-wrapper p-relative mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".7s">
               <div className="tp-blog-item-thumb">
                  <a href="/"><img src="assets/img/blog/img4.jpg" alt="" /></a>
               </div>

               <div className="tp-blog-item-content">

                  <h4 className="tp-blog-item-title"><a href="#!">Our mission</a></h4>
                  <p>
                     To provide innovative and responsive
                     services for older people, which
                     support Customer Focused Culture and them to have the best quality
                     of life.</p>
               </div>
            </div>
         </div>
...
// <!-- footer area start -->
<footer className="tp-footer-area  p-relative z-index-1"  style="background-color:rgb(12 12 12);">
